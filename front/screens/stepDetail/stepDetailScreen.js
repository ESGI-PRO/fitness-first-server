...
import { SafeAreaView, Dimensions, View, TouchableOpacity, StatusBar, ScrollView, Image, StyleSheet, Text } from "react-native";
    ...
    function readyDialog() {
        return (
            <Dialog.Container
                ...
                onRequestClose={() => { updateState({ showReadyDialog: false }) }}
            >
                <View style={{ backgroundColor: 'white', alignItems: 'center', }}>
                    <Text style={{ ...Fonts.blackColor16SemiBold, }}>
                        Are you Ready?
                    </Text>
                    <Text style={{ marginVertical: Sizes.fixPadding, textAlign: 'center', ...Fonts.grayColor13Regular }}>
                        Are you excited to start workout feel the energy inside you, focus on your today's goal, visiulise your dream body ads lets start
                    </Text>
                    <TouchableOpacity
                        activeOpacity={0.9}
                        onPress={() => {
    ...
    function exerciseDetail() {
        return (
            <View style={{ margin: Sizes.fixPadding * 2.0, }}>
                {
                    stepsDetailList.map((item, index) => (
