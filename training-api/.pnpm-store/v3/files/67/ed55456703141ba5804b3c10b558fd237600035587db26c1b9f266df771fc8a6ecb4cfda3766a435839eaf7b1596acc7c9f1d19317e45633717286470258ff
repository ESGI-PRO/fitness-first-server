...
__export(GatewayTimeoutError_exports, {
  GATEWAY_TIMEOUT_DEFAULT_MESSAGE: () => GATEWAY_TIMEOUT_DEFAULT_MESSAGE,
...
const GATEWAY_TIMEOUT_DEFAULT_MESSAGE = "Request timed out";
class GatewayTimeoutError extends import_DataProxyAPIError.DataProxyAPIError {
  constructor(info, message = GATEWAY_TIMEOUT_DEFAULT_MESSAGE) {
