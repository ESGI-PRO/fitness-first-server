...
export declare function prismaGraphQLToJSError({ error, user_facing_error }: RequestError, clientVersion: string): PrismaClientKnownRequestError | PrismaClientUnknownRequestError;
