...
${import_chalk.default.blue(
  "info"
)} You don't have any generators defined in your ${import_chalk.default.bold("schema.prisma")}, so nothing will be generated.
...
You don't have any ${import_chalk.default.bold("models")} defined in your ${import_chalk.default.bold(
  "schema.prisma"
