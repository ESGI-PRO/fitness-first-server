...
__export(UsageExceededError_exports, {
  USAGE_EXCEEDED_DEFAULT_MESSAGE: () => USAGE_EXCEEDED_DEFAULT_MESSAGE,
...
const USAGE_EXCEEDED_DEFAULT_MESSAGE = "Usage exceeded, retry again later";
class UsageExceededError extends import_DataProxyAPIError.DataProxyAPIError {
  constructor(info, message = USAGE_EXCEEDED_DEFAULT_MESSAGE) {
...
0 && (module.exports = {
  USAGE_EXCEEDED_DEFAULT_MESSAGE,
  UsageExceededError
});
